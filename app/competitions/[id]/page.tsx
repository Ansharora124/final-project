    ...
    return (
      <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          ...
          <p className="text-xs text-slate-400 mt-1 mb-6">The requested competition ID does not exist.</p>
      ...
      <div className="relative h-[380px] sm:h-[480px] w-full overflow-hidden bg-slate-950">
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900/80 border border-white/10 backdrop-blur-md text-xs">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
              ...
              />
              <span className="text-slate-200 font-medium">{competition.tenantName}</span>
            </div>
          ...
          {/* Meta Info Bar */}
          <div className="flex flex-wrap items-center gap-6 text-xs text-slate-300 pt-2 font-mono">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                      ...
                      >
                        ...
                        {prize.cashAmount && (
                          <div className="px-4 py-2 rounded-xl bg-slate-950 border border-slate-800 text-right shrink-0">
                            <p className="text-[10px] uppercase font-mono text-slate-400">Cash Award</p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-primary-400 font-medium">{judge.title}</p>
                        </div>
                      </div>
                      <p className="text-xs text-slate-400 leading-relaxed">{judge.bio}</p>
          ...
          <div className="space-y-6">
            <div className="sticky top-24 p-6 rounded-3xl bg-slate-900 border border-slate-800 space-y-6 shadow-2xl">
