      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full space-y-10">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-primary-500/10 text-primary-300 border border-primary-500/20">
              {competition.category}
            </span>
            <span className="text-xs text-slate-400">Prize Pool: {competition.prizePool}</span>
          </div>
        ...
        {existingSubmission ? (
          ...
          <div className="p-8 sm:p-12 rounded-3xl bg-slate-900 border border-slate-800 text-center space-y-6 animate-in zoom-in-95">
            ...
            <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 max-w-md mx-auto text-left text-xs space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-primary-400 font-mono font-bold">Queued for AI Evaluation</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-400">Jury Notification:</span>
                <span className="text-slate-300 font-mono">Upon Shortlist Threshold</span>
              </div>
            </div>
